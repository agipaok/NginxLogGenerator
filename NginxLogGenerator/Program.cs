namespace NginxLogGenerator
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                await writer.WriteLineAsync($"{entry.Id},{entry.Epoch},{entry.RemoteIpAddress},{entry.RemoteUser},{entry.Timestamp:yyyy-MM-dd HH:mm:ss zzz},{entry.RequestPath},{entry.StatusCode},{entry.BytesSent}");
            }
